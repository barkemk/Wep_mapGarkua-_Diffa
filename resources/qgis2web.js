...
map.getView().fit([12.682168, 13.364905, 12.797828, 13.437826], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Cartographie des interventions de l’ONG GARKOUA dans la Région de Diffa</h2>';
        return titleElement;
    })(),
